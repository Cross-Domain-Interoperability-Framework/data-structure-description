#!/usr/bin/env python3
"""
CDIF Data Structure Profile JSON-LD Framing and Validation Script
...
def main():
    parser = argparse.ArgumentParser(
        description='CDIF Data Structure Profile JSON-LD Framing and Validation Tool',
...
Examples:
  ...
  python FrameAndValidate.py my-metadata.jsonld --frame CDIFDataStructure-frame.jsonld -o framed.json

  # Validate against Data Description Profile schema
  python FrameAndValidate.py my-metadata.jsonld --frame CDIFDataStructure-frame.jsonld -v --schema cdifDataStructureStructuredSchema.json

  # Full workflow with Data Description Profile files
  python FrameAndValidate.py my-metadata.jsonld --frame CDIFDataStructure-frame.jsonld -o framed.json -v --schema cdifDataStructureStructuredSchema.json
"""
    )
    ...
    parser.add_argument('--schema', default=str(SCRIPT_DIR / 'cdifDataStructureStructuredSchema.json'),
                        help='Path to JSON Schema (default: cdifDataStructureStructuredSchema.json)')
    parser.add_argument('--frame', default=str(SCRIPT_DIR / 'CDIFDataStructure-frame.jsonld'),
                        help='Path to JSON-LD frame (default: CDIFDataStructure-frame.jsonld)')
