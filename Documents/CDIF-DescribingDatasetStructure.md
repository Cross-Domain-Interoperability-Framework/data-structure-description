...
| **cell_measures** | Links to measures like area or volume | "area: areacella"| Attribute Component |

#### Time-specific attributes
| Attribute   | Purpose  | CDIF Note |
| --------- | --------------- | --- |
